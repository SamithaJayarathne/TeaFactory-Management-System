 ...
 * @author sudan
 */
public class OrderCustomer extends javax.swing.JDialog {

    private static OrderManagement Cm2;

    public OrderCustomer(java.awt.Frame parent, boolean modal, JPanel jpanel) {
        super(parent, modal);
        initComponents();
...
//            public void run() {
//                OrderCustomer dialog = new OrderCustomer(new javax.swing.JFrame(), true);
