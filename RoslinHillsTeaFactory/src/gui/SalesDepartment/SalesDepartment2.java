...
public class SalesDepartment2 extends javax.swing.JPanel {

    public SalesDepartment2() {
        initComponents();
        toggleButtonBachground();

        // load default panel
        HRDashboard employees = new HRDashboard();
        jPanel10.removeAll();
    ...
    private void jToggleButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton6ActionPerformed
        ...
        LoanAndAdvance loan = new LoanAndAdvance();
        jPanel10.removeAll();
        jPanel10.add(loan);
        SwingUtilities.updateComponentTreeUI(jPanel10);
    ...
    private void jToggleButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton7ActionPerformed
        ...
        OvertimeManagement over = new OvertimeManagement();
        jPanel10.removeAll();
        jPanel10.add(over);
        SwingUtilities.updateComponentTreeUI(jPanel10);
    ...
    private void jToggleButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton1ActionPerformed
        ...
        PayrollManagementDashboard at = new PayrollManagementDashboard();
        jPanel10.removeAll();
        jPanel10.add(at);
        SwingUtilities.updateComponentTreeUI(jPanel10);
