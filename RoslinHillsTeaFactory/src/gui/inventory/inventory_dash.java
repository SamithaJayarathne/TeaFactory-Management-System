...
public class inventory_dash extends javax.swing.JPanel {
    ...
    public inventory_dash() {
        ...
        // load default panel
       InventoryDashboard in = new InventoryDashboard();
        jPanel10.removeAll();
        jPanel10.add(in);
    ...
    private void initComponents() {
        ...
        jToggleButton4.setText("RAW MATERIAL");
        ...
        jToggleButton5.setText("WAREHOUSE");
    ...
    private void jToggleButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton2ActionPerformed
        ...
        InventoryDashboard ds = new InventoryDashboard();
        jPanel10.removeAll();
        jPanel10.add(ds);
        SwingUtilities.updateComponentTreeUI(jPanel10);
    ...
    private void jToggleButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton5ActionPerformed
        ...
        jToggleButton7.setSelected(false);
         ...
         wareManager ware = new wareManager();
        jPanel10.removeAll();
        jPanel10.add(ware);
        SwingUtilities.updateComponentTreeUI(jPanel10);
