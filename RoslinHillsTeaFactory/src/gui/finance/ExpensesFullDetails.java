...
import gui.HRDeapartment.EmployeeView;
...
public class ExpensesFullDetails extends javax.swing.JPanel {

    public ExpensesFullDetails() {
        initComponents();
        tableCenter();
        loadIncomes();
        loadRound();
    ...
    private void loadRound() {
        ...
        jTextField1.putClientProperty(FlatClientProperties.PLACEHOLDER_TEXT, "Search by Reason");
    ...
    private void loadIncomes() {
        ...
        if (jTextField1.getText() != null && !jTextField1.getText().trim().isEmpty()) {
            query += " WHERE expences.reason LIKE '%" + jTextField1.getText().trim() + "%'";
            hasCondition = true;
        }
        ...
        if (jComboBox1.getSelectedItem() != null) {
            ...
            if (jComboBox1.getSelectedItem().equals("Date Latest first")) {
                orderBy = " ORDER BY expences.date DESC";
            } else if (jComboBox1.getSelectedItem().equals("Date Earlier first")) {
                orderBy = " ORDER BY expences.date ASC";
            } else if (jComboBox1.getSelectedItem().equals("Amount low to high")) {
                orderBy = " ORDER BY expences.total_amount ASC";
            } else if (jComboBox1.getSelectedItem().equals("Amount high to low")) {
                orderBy = " ORDER BY expences.total_amount DESC";
            }
        ...
        try {
            ...
            while (rs.next()) {
                ...
                vector.add(rs.getString("reason"));
                vector.add(rs.getDouble("total_amount"));
                model.addRow(vector);
            }
        } catch (Exception ex) {
            Logger.getLogger(ExpensesFullDetails.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    private void initComponents() {
        ...
        jPanel2.setPreferredSize(new java.awt.Dimension(308, 45));

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 24)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(0, 0, 0));
        jLabel1.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel1.setText("Expenses - Full Details");

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/resources/icons8-red-circle-40.png"))); // NOI18N
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Date Latest first", "Date Earlier first", "Amount low to high", "Amount high to low" }));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            InputStream reportStream = getClass().getResourceAsStream("/reports/Finance/Expenses.jasper");
