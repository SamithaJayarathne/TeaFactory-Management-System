 ...
 */
public class Oxidation extends javax.swing.JPanel {
    ...
    private void loadData() {
        try {
            ResultSet rs = MySQL.executeSearch("SELECT * FROM `oxidation` ORDER BY `oxidation`.`id` DESC");
            ...
            while (rs.next()) {
                ...
                vector.add(rs.getString("humidity"));
                model.addRow(vector);
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void updateRow(String batchId) {
        try {
            ResultSet rs = MySQL.executeSearch("SELECT * FROM `oxidation` WHERE `tea_batch_id` = '" + batchId + "'");
            DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
            ...
            while (rs.next()) {
                ...
                for (int row = 0; row < model.getRowCount(); row++) {
                    if (model.getValueAt(row, 0).equals(batchId)) {
                        ...
                        model.setValueAt(rs.getString("humidity"), row, 5);
                        break;
                    }
                }
            }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Batch ID", "Start Time", "End Time", "Processed Date", "Temperature", "Humidity"
            }
        ) {
        ...
        jButton3.setText("Add To Oxidicing Machine");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        home home = new home();
        Machines mac = new Machines(home, true, this, "oxidation");
        mac.setVisible(true);
        mac.setMachines(mac);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        home home = new home();
        TeaBatches tbat = new TeaBatches(home, true, this, "oxidation");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        home home = new home();
        Time ti = new Time(home, true, this, "start", "oxidation");
        ti.setVisible(true);
        ti.setTime(ti);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        home home = new home();
        Time ti2 = new Time(home, true, this, "end", "oxidation");
        ti2.setVisible(true);
        ti2.setTime(ti2);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            ...
            if (batch.isEmpty()) {
                ...
                MySQL.executeIUD("INSERT INTO `oxidation` (`tea_batch_id`, `start_time`, `end_time`, `temperature`, `humidity`,`processed_date`, `production_status_id`)"
                        + "VALUES ('" + batch + "','" + startTime + "','" + endTime + "','" + temperature + "','" + humidity + "','" + date + "','4')");

                MySQL.executeIUD("UPDATE `tea_batch` SET `production_status_id` = '3' WHERE `id` = '" + batch + "'");

                startBatchProgress();
                JOptionPane.showMessageDialog(this, "Added to Oxidicing Machine Successfully", "Warning", JOptionPane.OK_OPTION);
                reset();
            }
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        try {
            ...
            ResultSet rs = MySQL.executeSearch("SELECT * FROM `oxidation` WHERE `processed_date` BETWEEN '" + stdate + "' AND '" + eddate + "' ORDER BY `id` DESC");
    ...
    private void jProgressBar1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jProgressBar1MouseClicked
        ...
        if (jProgressBar1.getValue() == 0) {
            ...
            try {
                MySQL.executeIUD("UPDATE `tea_batch` SET `production_status_id` = '8' WHERE `tea_batch`.`id` = '" + batchId + "'");
            } catch (Exception e) {
                e.printStackTrace();
            }
            updateRow(batchId);
    ...
    private void jProgressBar2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jProgressBar2MouseClicked
        ...
        if (jProgressBar2.getValue() == 0) {
            ...
            try {
                MySQL.executeIUD("UPDATE `tea_batch` SET `production_status_id` = '8' WHERE `tea_batch`.`id` = '" + jLabel5.getText() + "'");
            } catch (Exception e) {
                e.printStackTrace();
            }
            updateRow(batchId);
    ...
    private void jProgressBar3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jProgressBar3MouseClicked
        ...
        if (jProgressBar3.getValue() == 0) {
            ...
            try {
                MySQL.executeIUD("UPDATE `tea_batch` SET `production_status_id` = '8' WHERE `tea_batch`.`id` = '" + jLabel7.getText() + "'");
            } catch (Exception e) {
                e.printStackTrace();
            }
            updateRow(batchId);
