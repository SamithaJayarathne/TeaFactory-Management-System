 ...
 */
public class Drying extends javax.swing.JPanel {
    ...
    private void loadData() {
        try {
            ResultSet rs = MySQL.executeSearch("SELECT * FROM `drying` ORDER BY `drying`.`id` DESC");
            ...
            while (rs.next()) {
                ...
                vector.add(rs.getString("temperature"));
                vector.add(rs.getString("moisture"));
                model.addRow(vector);
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void updateRow(String batchId) {
        try {
            ResultSet rs = MySQL.executeSearch("SELECT * FROM `drying` WHERE `tea_batch_id` = '" + batchId + "'");
            DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
            ...
            while (rs.next()) {
                ...
                for (int row = 0; row < model.getRowCount(); row++) {
                    if (model.getValueAt(row, 0).equals(batchId)) {
                        ...
                        model.setValueAt(rs.getString("temperature"), row, 4);
                        model.setValueAt(rs.getString("moisture"), row, 5);
                        break;
                    }
                }
            }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Batch ID", "Start Time", "End Time", "Processed Date", "Temperature", "Moisture"
            }
        ) {
        ...
        jButton3.setText("Add To Drying Machine");
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(jProgressBar3, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 646, javax.swing.GroupLayout.PREFERRED_SIZE))))
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        home home = new home();
        Machines mac = new Machines(home, true, this, "drying");
        mac.setVisible(true);
        mac.setMachines(mac);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        home home = new home();
        TeaBatches tbat = new TeaBatches(home, true, this, "drying");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        home home = new home();
        Time ti = new Time(home, true, this, "start", "drying");
        ti.setVisible(true);
        ti.setTime(ti);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        home home = new home();
        Time ti2 = new Time(home, true, this, "end", "drying");
        ti2.setVisible(true);
        ti2.setTime(ti2);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        int moisture = jSlider2.getValue();
        ...
        try {
            ...
            if (batch.isEmpty()) {
                ...
                JOptionPane.showMessageDialog(this, "You Haven't Set Moisture", "Warning", JOptionPane.WARNING_MESSAGE);
                ...
                MySQL.executeIUD("INSERT INTO `drying` (`tea_batch_id`, `start_time`, `end_time`, `temperature`, `moisture`,`processed_date`, `production_status_id`)"
                        + "VALUES ('" + batch + "','" + startTime + "','" + endTime + "','" + temperature + "','" + moisture + "','" + date + "','5')");

                MySQL.executeIUD("UPDATE `tea_batch` SET `production_status_id` = '3' WHERE `id` = '" + batch + "'");

                startBatchProgress();
                JOptionPane.showMessageDialog(this, "Added to Drying Machine Successfully", "Warning", JOptionPane.OK_OPTION);
                reset();
            }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            InputStream path = this.getClass().getResourceAsStream("/reports/Production/drying.jasper");
            String date = new SimpleDateFormat("yyyy-MM-dd").format(new Date());
    ...
    private void jProgressBar1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jProgressBar1MouseClicked
        ...
        if (jProgressBar1.getValue() == 0) {
            ...
            try {
                MySQL.executeIUD("UPDATE `tea_batch` SET `production_status_id` = '9' WHERE `tea_batch`.`id` = '" + batchId + "'");
            } catch (Exception e) {
                e.printStackTrace();
            }
            updateRow(batchId);
    ...
    private void jProgressBar2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jProgressBar2MouseClicked
        ...
        if (jProgressBar2.getValue() == 0) {
            ...
            try {
                MySQL.executeIUD("UPDATE `tea_batch` SET `production_status_id` = '9' WHERE `tea_batch`.`id` = '" + jLabel5.getText() + "'");
            } catch (Exception e) {
                e.printStackTrace();
            }
            updateRow(batchId);
    ...
    private void jProgressBar3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jProgressBar3MouseClicked
        ...
        if (jProgressBar3.getValue() == 0) {
            ...
            try {
                MySQL.executeIUD("UPDATE `tea_batch` SET `production_status_id` = '9' WHERE `tea_batch`.`id` = '" + jLabel7.getText() + "'");
            } catch (Exception e) {
                e.printStackTrace();
            }
            updateRow(batchId);
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        try {
            ...
            ResultSet rs = MySQL.executeSearch("SELECT * FROM `drying"
                    + "` WHERE `processed_date` BETWEEN '" + stdate + "' AND '" + eddate + "' ORDER BY `id` DESC");
