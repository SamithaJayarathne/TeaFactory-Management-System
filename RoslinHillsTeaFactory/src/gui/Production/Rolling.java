 ...
 */
public class Rolling extends javax.swing.JPanel {
    ...
    private void loadData() {
        try {
            ResultSet rs = MySQL.executeSearch("SELECT * FROM `rolling` ORDER BY `rolling`.`id` DESC");
            ...
            while (rs.next()) {
                ...
                vector.add(rs.getString("pressure"));
                vector.add(rs.getString("speed"));
                model.addRow(vector);
            }
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void updateRow(String batchId) {
        try {
            ResultSet rs = MySQL.executeSearch("SELECT * FROM `rolling` WHERE `tea_batch_id` = '" + batchId + "'");
            DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
            ...
            while (rs.next()) {
                ...
                for (int row = 0; row < model.getRowCount(); row++) {
                    if (model.getValueAt(row, 0).equals(batchId)) {
                        ...
                        model.setValueAt(rs.getString("pressure"), row, 4);
                        model.setValueAt(rs.getString("speed"), row, 5);
                        break;
                    }
                }
            }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Batch ID", "Start Time", "End Time", "Processed Date", "Pressure", "Speed"
            }
        ) {
        ...
        jButton3.setText("Add To Rolling Machine");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        home home = new home();
        Machines mac = new Machines(home, true, this, "Rolling");
        mac.setVisible(true);
        mac.setMachines(mac);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        home home = new home();
        TeaBatches tbat = new TeaBatches(home, true, this, "rolling");
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        home home = new home();
        Time ti = new Time(home, true, this, "start", "rolling");
        ti.setVisible(true);
        ti.setTime(ti);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        home home = new home();
        Time ti2 = new Time(home, true, this, "end", "rolling");
        ti2.setVisible(true);
        ti2.setTime(ti2);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String batch = jTextField1.getText();
        String machine = jTextField2.getText();
        int pressure = jSlider1.getValue();
        int speed = jSlider2.getValue();
        ...
        try {
            ...
            if (batch.isEmpty()) {
                ...
                JOptionPane.showMessageDialog(this, "You Haven't Set Pressure", "Warning", JOptionPane.WARNING_MESSAGE);
            } else if (!isMoved2[0]) {
                JOptionPane.showMessageDialog(this, "You Haven't Set Speed", "Warning", JOptionPane.WARNING_MESSAGE);
                ...
                MySQL.executeIUD("INSERT INTO `rolling` (`tea_batch_id`, `start_time`, `end_time`, `pressure`, `speed`,`processed_date`, `production_status_id`)"
                        + "VALUES ('" + batch + "','" + startTime + "','" + endTime + "','" + pressure + "','" + speed + "','" + date + "','3')");

                MySQL.executeIUD("UPDATE `tea_batch` SET `production_status_id` = '3' WHERE `id` = '" + batch + "'");

                startBatchProgress();
                JOptionPane.showMessageDialog(this, "Added to Rolling Machine Successfully", "Warning", JOptionPane.OK_OPTION);
                reset();
            }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            InputStream path = this.getClass().getResourceAsStream("/reports/Production/rolling.jasper");
            String date = new SimpleDateFormat("yyyy-MM-dd").format(new Date());
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        try {
            ...
            ResultSet rs = MySQL.executeSearch("SELECT * FROM `rolling` WHERE `processed_date` BETWEEN '" + stdate + "' AND '" + eddate + "' ORDER BY `id` DESC");
    ...
    private void jProgressBar1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jProgressBar1MouseClicked
        ...
        if (jProgressBar1.getValue() == 0) {
            ...
            try {
                MySQL.executeIUD("UPDATE `tea_batch` SET `production_status_id` = '7' WHERE `tea_batch`.`id` = '" + batchId + "'");
            } catch (Exception e) {
                e.printStackTrace();
            }
            updateRow(batchId);
    ...
    private void jProgressBar2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jProgressBar2MouseClicked
        ...
        if (jProgressBar2.getValue() == 0) {
            ...
            try {
                MySQL.executeIUD("UPDATE `tea_batch` SET `production_status_id` = '7' WHERE `tea_batch`.`id` = '" + jLabel5.getText() + "'");
            } catch (Exception e) {
                e.printStackTrace();
            }
            updateRow(batchId);
    ...
    private void jProgressBar3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jProgressBar3MouseClicked
        ...
        if (jProgressBar3.getValue() == 0) {
            ...
            try {
                MySQL.executeIUD("UPDATE `tea_batch` SET `production_status_id` = '7' WHERE `tea_batch`.`id` = '" + jLabel7.getText() + "'");
            } catch (Exception e) {
                e.printStackTrace();
            }
            updateRow(batchId);
