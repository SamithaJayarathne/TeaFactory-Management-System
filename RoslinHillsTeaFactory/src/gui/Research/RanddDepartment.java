...
public class RanddDepartment extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jToggleButton3.setText("PROJECTS");
        ...
        jToggleButton5.setText("TEA BLENDS");
        ...
        jToggleButton7.setText("BUDGET MANAGEMENT");
    ...
    private void jToggleButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton4ActionPerformed
        ...
        jPanel10.removeAll();
        jPanel10.setLayout(new java.awt.BorderLayout()); // Add this line
        jPanel10.add(rm, BorderLayout.CENTER);
...
// Force layout validation
    ...
    private void jToggleButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jToggleButton7ActionPerformed
        ...
        BudgetManagement bmi = new BudgetManagement();
        jPanel10.removeAll();
        jPanel10.add(bmi);
        SwingUtilities.updateComponentTreeUI(jPanel10);
